ALTER TABLE "gola_completions" RENAME TO "goal_completions";--> statement-breakpoint
ALTER TABLE "goal_completions" DROP CONSTRAINT "gola_completions_goal_id_goals_id_fk";
